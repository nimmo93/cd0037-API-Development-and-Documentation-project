...
class TriviaTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.database_path = "postgresql://{}:{}@{}/{}".format('teresia', '1234', 'localhost:5432', self.database_name)
    ...
    def test_404_sent_retrieving_categories(self):
    ...
    def test_create_new_question(self):
        new_question = {
            "question":"Whose autobiography is entitled 'Finding Me'?", 
            "answer":"Viola Davis", 
            "difficulty":2, 
            "category":4
        }
    ...
    def test_404_retrieve_by_category(self):
        res = self.client().get('/categories/e/questions')
        data = json.loads(res.data)
    ...
    def test_404_search_question(self):
        ...
        res = self.client().post('/questions/search/2', json=new_search)
        data = json.loads(res.data)
